            ...
            <div className='grid lg:grid-cols-[300px,1fr] gap-4'>
                <div className='border border-gray-300 rounded-2xl grid place-items-center p-6 lg:p-0'>
                    <div className='text-center flex flex-col items-center gap-1'>
                        <Image className='rounded-full inline-block' src={`${process.env.assetPrefix}/user.jpg`} width={80} height={80} alt="profile"/>
                        <h2 className='text-gray-500 font-black text-[20px]'>Elsa Doe</h2>
                        <p>CEO & Founder Invision</p>
                        <Image className='inline-block py-2' src={`${process.env.assetPrefix}/quotes.svg`} width={30} height={30} alt="quotes"/>
                ...
                <div className='bg-red-600 bg-[url(${process.env.assetPrefix}/cta-banner.jpg)] bg-cover h-[500px] rounded-2xl grid place-items-center'>
